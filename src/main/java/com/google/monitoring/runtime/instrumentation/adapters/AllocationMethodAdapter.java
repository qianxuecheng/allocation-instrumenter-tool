 ...
 * @author Ami Fischman
 */
public class AllocationMethodAdapter extends MethodVisitor {
    /**
    ...
    private static class VariableScope {
        ...
        public VariableScope(final int index,
                             final Label start,
                             final Label end,
                             final String desc) {
            this.index = index;
    ...
    public AllocationMethodAdapter(final MethodVisitor mv,
    ...
    private void buildRecorderFromObject(final int opcode,
                                         final String owner,
                                         final String name,
                                         final String signature,
                                         final boolean itf) {
     ...
     * compute stack and local variable count maximums.
     */
    @Override
    ...
    private int newLocal(final Type type,
                         final String typeDesc,
                         final Label begin,
                         final Label end) {
        final int newVar = lvs.newLocal(type);
    ...
    // know.
    private int newLocal(final String typeDescriptor, final Label begin, final Label end) {
        return newLocal(Type.getType(typeDescriptor), typeDescriptor, begin, end);
    }

    private int newLocal(final Type type, final Label begin, final Label end) {
     ...
     */
    @Override
    public void visitMultiANewArrayInsn(final String typeName, final int dimCount) {
